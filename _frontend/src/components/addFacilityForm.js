export default function AddFacilityForm (props){
    ...
    return(
        <form className=" facilityForm" onSubmit={(e)=>{handleSubmit(e)}} enctype="multipart/form-data">
            ...
            <label className="text-xs text-gray-500 font-medium  ">Add photos of the facility</label>
            <input multiple className="inputfile" type="file" required name="images" placeholder="Images" accept="image/png, image/jpg," onChange={(e)=>{handleFacilityDetailsChange(e)}}></input>
