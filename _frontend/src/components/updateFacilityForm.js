export default function UpdateFacilityForm (props){
    ...
    return(
        <form className=" facilityForm" onSubmit={(e)=>{handleSubmit(e)}}>
            ...
            <input disabled className="inputfile" type="file" required name="image" placeholder="Image" accept="image/jpg" value={facilityInfo.img} onChange={(e)=>{handleFacilityDetailsChange(e)}}></input>
